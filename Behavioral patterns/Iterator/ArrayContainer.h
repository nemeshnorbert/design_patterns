...
{
public:
    ArrayContainer() : ArrayContainer(DEFAULT_SIZE)
    {}

    ArrayContainer(size_t count) : AbstractContainer(count, T())
    {}
    ...
    {
        return std::make_shared<ArrayIterator<T>>(shared_from_this());
    }
